...
public class DBCPConnectionProvider implements ConnectionProvider, Configurable, Stoppable, ServiceRegistryAwareService {
	...
	// LoggerFactory.getLogger(DBCPConnectionProvider.class);
	// private static final String PREFIX = "hibernate.dbcp.";
	// private BasicDataSource ds;
	//
	// // Old Environment property for backward-compatibility (property removed
	// in Hibernate3)
	...
	// (String)props.get("javax.persistence.jdbc.driver");
	// String jdbcUrl = (String)props.get("javax.persistence.jdbc.url");
	...
	//
	// // Pool size
	// String poolSize = (String)props.get("hibernate.dbcp.maxActive");
